...
import com.kostya.cranegrabe.filedialog.view.FileItem;
...
class FileChooserCore {
	 ...
	 */
	private com.kostya.cranegrabe.filedialog.FileChooserLabels labels;
	 ...
	 */
	public void setLabels(com.kostya.cranegrabe.filedialog.FileChooserLabels labels) {
		this.labels = labels;
