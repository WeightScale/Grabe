//Активность настроек
package com.kostya.cranegrabe.settings;
...
import com.kostya.cranegrabe.ActivityAbout;
import com.kostya.cranegrabe.ActivityTest;
import com.kostya.cranegrabe.Globals;
import com.kostya.cranegrabe.R;
import com.kostya.cranegrabe.filedialog.FileChooserDialog;
    ...
    public enum KEY{
        DELTA_STAB(R.string.KEY_DELTA_STAB){
            ...
            class MyOnPreferenceChangeListener implements Preference.OnPreferenceChangeListener {
                ...
                public MyOnPreferenceChangeListener(Context context, CharSequence title) {
