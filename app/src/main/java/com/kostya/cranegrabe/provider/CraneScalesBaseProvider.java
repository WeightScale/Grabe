package com.kostya.cranegrabe.provider;
...
public class CraneScalesBaseProvider extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, com.kostya.cranegrabe.provider.InvoiceTable.TABLE, TableList.INVOICE_LIST.ordinal());
        uriMatcher.addURI(AUTHORITY, com.kostya.cranegrabe.provider.InvoiceTable.TABLE + "/#", TableList.INVOICE_ID.ordinal());
        uriMatcher.addURI(AUTHORITY, com.kostya.cranegrabe.provider.WeighingTable.TABLE, TableList.WEIGHING_LIST.ordinal());
        uriMatcher.addURI(AUTHORITY, com.kostya.cranegrabe.provider.WeighingTable.TABLE + "/#", TableList.WEIGHING_ID.ordinal());
    }
    ...
    private String getTable(Uri uri) {
        switch (TableList.values()[uriMatcher.match(uri)]) {
            case INVOICE_LIST:
            case INVOICE_ID:
                return com.kostya.cranegrabe.provider.InvoiceTable.TABLE; // return
            case WEIGHING_LIST:
            case WEIGHING_ID:
                return com.kostya.cranegrabe.provider.WeighingTable.TABLE; // return
