...
public class Globals {
    ...
    /** Настройки для весов. */
    public com.kostya.cranegrabe.Preferences preferencesScale;
    ...
    public com.kostya.cranegrabe.Preferences getPreferencesScale() {
    ...
    public void initialize(Context context) {
        ...
        preferencesScale = new com.kostya.cranegrabe.Preferences(context.getApplicationContext());//загрузить настройки
